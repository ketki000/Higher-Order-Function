function slice() {
    ...
    if (num1 >= 0 && num1 <= 7 && num2 >= 1 && num2 <= 8) {
        ...
        document.getElementById("out1").innerText = "Modified Food = [" + modifiedFood + "]";
    }
    else {
...
function Addsplice() {
    ...
    if (num1 >= 0 && num1 <= 4) {
        ...
        document.getElementById("out2").innerText = "Modified Food = [" + modifiedFood + "]";
    }
    else {
...
function isEven() {
    ...
    document.getElementById("out3").innerText = "Even Number Array = [" + res + "]";
    return res;
}
...
function isprime() {
    ...
    document.getElementById("out4").innerText = "Not prime = [" + notprime + "]";
    return notprime;
}
...
function checkEven() {
    ...
    document.getElementById("out5").innerText = "Even Number Array = [" + res + "]";
    return res;
}
...
function findSquare() {
    ...
    document.getElementById("out6").innerText = "Square of Array = [" + " " + output + " " + "]";
    return output;
}
